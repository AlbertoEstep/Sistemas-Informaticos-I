			...
			<div class="content">
				<?php
					if (isset($_POST['submit'])) {
						...
						$stmt = $dbh->prepare("SELECT customerid FROM customers WHERE username = :username");
					    ...
					    if(count($result) == 0){
					    	// INSERTAR DATOS
							$stmt = $dbh->prepare('INSERT INTO customers(customerid,username,password,email,phone,creditcard,income) VALUES (default,:username,:password,:email,:phone,:creditcard,:income)');
						    ...
						    $stmt->bindParam(':income',$saldo, PDO::PARAM_INT);
					    	...
					    	printf("Register Data Incorrect");
